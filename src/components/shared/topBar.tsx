...
const Profile = ({ isOpened, handlePopState }: { isOpened: Boolean, handlePopState: any }) => {
  return (
    <div className="relative">
      ...
      <div className={`${!isOpened && 'hidden'} absolute top-[150%] -right-2 z-50 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600`} onClick={handlePopState}>
          <div className="py-3 px-4">
            ...
            <span className="block text-sm text-gray-500 truncate dark:text-gray-400">user@name.com</span>
          </div>
      ...
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
        <div className="flex flex-wrap justify-between items-center">
          ...
          <div className="flex gap-3 items-center lg:order-2">
            ...
            <Profile isOpened={popUpStates.profile} handlePopState={() => handleOpenPopUps('profile')} />
          </div>
        </div>
      </nav>
    </Card>
