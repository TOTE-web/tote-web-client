...
const Notifications = ({ isOpened, handlePopState }: { isOpened: Boolean, handlePopState: any }) => {
  return (
    <div className="relative">
      <div className={`p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 cursor-pointer ${isOpened && 'bg-gray-100 text-gray-900'}`}  onClick={handlePopState}>
      ...
      <div className={`${!isOpened ? 'hidden' : ''} absolute top-[150%] -right-10 w-max overflow-hidden z-50 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:divide-gray-600 dark:bg-gray-700`}>
        ...
        <a href="#" className="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
          ...
          {/* <Image className="w-11 h-11 rounded-full" width={1000} height={0} src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png" alt="Bonnie Green avatar"/> */}
          ...
          <div className="pl-3 w-full">
            <div className="text-gray-500 font-normal text-sm mb-1.5">New message from <span className="font-semibold text-gray-900 dark:text-white">Bonnie Green</span>: {"Hey, what's up? All set for the presentation?"}</div>
            <div className="text-xs font-medium text-primary-700 dark:text-primary-400">a few moments ago</div>
          </div>
        </a>
        <a href="#" className="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
          <div className="flex-shrink-0">
            {/* <Image className="w-11 h-11 rounded-full" width={1000} height={0} src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/jese-leos.png" alt="Jese Leos avatar"/> */}
          ...
          <div className="pl-3 w-full">
            <div className="text-gray-500 font-normal text-sm mb-1.5"><span className="font-semibold text-gray-900 dark:text-white">Jese leos</span> and <span className="font-medium text-gray-900 dark:text-white">5 others</span> started following you.</div>
            <div className="text-xs font-medium text-primary-700 dark:text-primary-400">10 minutes ago</div>
          </div>
        </a>
        <a href="#" className="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
          <div className="flex-shrink-0">
            {/* <Image className="w-11 h-11 rounded-full" width={1000} height={0} src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/joseph-mcfall.png" alt="Joseph McFall avatar"/> */}
          ...
          <div className="pl-3 w-full">
            <div className="text-gray-500 font-normal text-sm mb-1.5"><span className="font-semibold text-gray-900 dark:text-white">Joseph Mcfall</span> and <span className="font-medium text-gray-900 dark:text-white">141 others</span> love your story. See it and view more stories.</div>
            <div className="text-xs font-medium text-primary-700 dark:text-primary-400">44 minutes ago</div>
          </div>
        </a>
        <a href="#" className="flex py-3 px-4 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
          <div className="flex-shrink-0">
            {/* <Image className="w-11 h-11 rounded-full" width={1000} height={0} src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/roberta-casas.png" alt="Roberta Casas image"/> */}
          ...
          <div className="pl-3 w-full">
            <div className="text-gray-500 font-normal text-sm mb-1.5"><span className="font-semibold text-gray-900 dark:text-white">Leslie Livingston</span> mentioned you in a comment: <span className="font-medium text-primary-700 dark:text-primary-500">@bonnie.green</span> what do you say?</div>
        ...
        <a href="#" className="flex py-3 px-4 hover:bg-gray-100 dark:hover:bg-gray-600">
          <div className="flex-shrink-0">
            {/* <Image className="w-11 h-11 rounded-full" width={1000} height={0} src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/robert-brown.png" alt="Robert image"/> */}
          ...
          <div className="pl-3 w-full">
            <div className="text-gray-500 font-normal text-sm mb-1.5"><span className="font-semibold text-gray-900 dark:text-white">Robert Brown</span> posted a new video: Glassmorphism - learn how to implement the new design trend.</div>
...
const Apps = ({ isOpened, handlePopState }: { isOpened: Boolean, handlePopState: any }) => {
  return (
    <div className="relative">
      <div className={`p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 cursor-pointer ${isOpened && 'bg-gray-100 text-gray-900'}`} onClick={handlePopState}>
      ...
      <div className={`${!isOpened ? 'hidden' : ''} absolute top-[150%] -right-6 w-max block overflow-hidden z-50 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600`}>
        <div className="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700">
          Apps
        </div>
...
const Profile = ({ isOpened, handlePopState, onClickLogout }: { isOpened: Boolean, handlePopState: any, onClickLogout: any }) => {
  return (
    <div className="relative">
      <div className="flex rounded-full md:mr-0 cursor-pointer" onClick={handlePopState}>
        <Image src="/assets/home/user.png" width={1000} height={0} alt='user' className='w-8' />
      </div>
      <div className={`${!isOpened && 'hidden'} absolute top-[150%] -right-2 z-50 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600`} onClick={handlePopState}>
        <div className="py-3 px-4">
          <span className="block text-sm font-semibold text-gray-900 dark:text-white">User Name</span>
          <span className="block text-sm text-gray-500 truncate">user@name.com</span>
        </div>
        <ul className="py-1 text-gray-500" aria-labelledby="dropdown">
          <li>
            <Link href='/profile' className="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">My profile</Link>
          </li>
          <li>
            <Link href='/preferences' className="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white">Account settings</Link>
          </li>
        </ul>
        <ul className="py-1 text-gray-500" aria-labelledby="dropdown">
          <li className='cursor-pointer' onClick={onClickLogout}>
            <div className="block py-2 px-4 text-sm text-red-400 hover:text-red-500 hover:bg-gray-100">Sign out</div>
          </li>
        </ul>
      </div>
    </div>
...
const initialStatePops = { 
  notifications: false, apps: false, profile: false
};

const TopBar = ({ className, toggleSideBar }: { className: string, toggleSideBar: any }) => {
  const [popUpStates, setPopUpStates] = useState<any>({ ...initialStatePops });
  const router = useRouter();

  const handleOpenPopUps = (stateText: any) => {
    const updatedState = { ...initialStatePops, [stateText]: !popUpStates[stateText] };
    setPopUpStates(updatedState);
  }
  ...
  return (
    <Card className={cn("antialiased rounded-none", className)}>
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5">
        <div className="flex flex-wrap justify-between items-center">
          <div className="flex justify-start items-center">
            <div className="p-2 text-gray-600 rounded-lg cursor-pointer hover:text-gray-900 hover:bg-gray-100 focus:bg-gray-100 focus:ring-2 focus:ring-gray-100" onClick={toggleSideBar}>
          ...
          <div className="flex gap-3 items-center lg:order-2">
            <Notifications isOpened={popUpStates.notifications} handlePopState={() => handleOpenPopUps('notifications')} />
            <Apps isOpened={popUpStates.apps} handlePopState={() => handleOpenPopUps('apps')} />
            <Profile isOpened={popUpStates.profile} handlePopState={() => handleOpenPopUps('profile')} onClickLogout={handleLogout} />
          </div>
        </div>
      </nav>
    </Card>
